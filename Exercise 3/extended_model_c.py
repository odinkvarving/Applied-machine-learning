...
# Divide training data into batches to speed up optimization (uses less memory and less data to find gradient for)
batches = 600
...
class ConvolutionalNeuralNetworkModel(nn.Module):
    def __init__(self):
        ...
        self.logits = nn.Sequential(
            ...
            nn.Linear(1024, 10),
            #Tried adding nn.Dropout aswell, did not cause better accuracy.
        )
